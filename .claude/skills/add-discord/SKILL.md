---
name: add-discord
description: Add Discord bot channel integration to ClawDad.
---

# Add Discord Channel

This skill adds Discord support to ClawDad, then walks through interactive setup.
...
4. Service is running: `launchctl list | grep clawdad`
...
- @mention translation (Discord `<@botId>` → ClawDad trigger format)
