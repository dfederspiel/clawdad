...
This skill adds Slack support to ClawDad, then walks through interactive setup.
...
>
> The JID format for ClawDad is: `slack:C0123456789`
...
6. Restart: `launchctl kickstart -k gui/$(id -u)/com.clawdad`
