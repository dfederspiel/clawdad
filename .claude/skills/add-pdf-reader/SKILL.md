---
name: add-pdf-reader
description: Add PDF reading to ClawDad agents. Extracts text from PDFs via pdftotext CLI. Handles WhatsApp attachments, URLs, and local files.
---
...
```bash
tail -f logs/clawdad.log | grep -i pdf
```
